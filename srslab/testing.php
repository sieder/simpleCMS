...
?>
<div style="float:left; padding: 10px 10px 10px 10px; border: 1px solid gray;margin-left:10px;margin-top:10px;">
...
?>
   ...
   <body>
      ...
      <form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>" name="searchForm">
         ...
         Search In:<br />
         Product_Name: <input type="checkbox" name="Product_Name" value="on" <?php echo isset($_GET['Product_Name'])?"checked":''; ?> /> | 
         Product_ID: <input type="checkbox" name="Product_ID" value="on" <?php echo isset($_GET['Product_ID'])?"checked":''; ?> /> | 
         Testing_ID: <input type="checkbox" name="Testing_ID" value="on" <?php echo isset($_GET['Testing_ID'])?"checked":''; ?> /><br />
